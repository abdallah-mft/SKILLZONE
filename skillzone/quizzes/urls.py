...
urlpatterns = [
    ...
    path('courses/<course_id>/quizzes/', views.quiz_list, name='quiz-list'),
    ...
    path('courses/<int:course_id>/quiz_data/', views.quiz_data_for_frontend, name='quiz-data-for-frontend'),
]
